...
const handleChang = (data) => {
  ...
  return (
    <section className='bg-white from-[#FBF9F4] to-[#fff] md:h-[85vh] h-auto px-2 md:px-0 '>
          ...
          <div className='md:w-[40%] w-full 5/5 relative md:px-2'>
            <div className='md:absolute md:left-[20%] flex py-20 md:py-0 items-center h-full w-full '>
              <div className=' pr-2 pl-1 md:pl-0 md:w-[80%] w-full'>
                ...
                <div className='w-[510px] md:w-full'>
                  <form className='flex border border-black '>
                    <input className='text-black w-full px-3 bg-transparent focus:outline-none' type="text" value={input} onChange={handleChang} name="seearch" placeholder='Search your product here...' />
